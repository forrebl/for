...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'Комиксы',
    categorySlug: 'comics',
    thumbnail: 'https://placehold.co/800x600/5b416e/fafaf8?text=К+себе',
    cover: 'https://placehold.co/1400x800/5b416e/fafaf8?text=К+себе',
    task: '',
    role: '',
    description: '',
    processImages: [],
  ...
  },
  {
    ...
    category: 'Комиксы',
    categorySlug: 'comics',
    thumbnail: 'https://placehold.co/800x600/3e5368/fafaf8?text=Омут',
    cover: 'https://placehold.co/1400x800/3e5368/fafaf8?text=Омут',
    task: '',
    role: '',
    description: '',
    processImages: [],
