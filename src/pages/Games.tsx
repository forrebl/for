      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <Reveal>
          <div className="inline-flex items-center gap-2 mb-4">
            <span className="w-2 h-2 bg-[#00b8d9] shadow-[4px_0_0_#e6007e,8px_0_0_#f2d500]" />
            <p className="ml-8 text-xs uppercase tracking-[0.22em] text-[#00b8d9] font-medium">игры</p>
          </div>
          <h1 className="font-[family-name:var(--font-display)] font-medium mb-4 text-white [text-shadow:3px_3px_0_#2a3fc7]">
            Сделай паузу
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 lg:gap-9 items-stretch">
          {games.map((game, index) => (
            <Reveal key={game.path} delay={index * 100} className="h-full">
              <Link
                to={game.path}
                className={`group h-full flex flex-col border-2 border-white/15 bg-[#111] overflow-hidden transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 ${
                  index === 0
                    ? 'shadow-[8px_8px_0_#2a3fc7] hover:shadow-[12px_12px_0_#00b8d9]'
                    : 'shadow-[8px_8px_0_#e6007e] hover:shadow-[12px_12px_0_#f2d500]'
                }`}
              >
                <div className="relative w-full aspect-[16/9] shrink-0 overflow-hidden border-b-2 border-white/15 bg-[#161616]">
                  {game.preview === 'cmyk' ? (
                    ...
                    >
                      <span className="absolute top-7 left-[12%] px-3 py-2 bg-[#00b8d9] text-white text-xs sm:text-sm font-medium border-2 border-[#0a0a0a] shadow-[4px_4px_0_#0a0a0a]">Идея</span>
                      <span className="absolute top-20 right-[12%] px-3 py-2 bg-[#e6007e] text-white text-xs sm:text-sm font-medium border-2 border-[#0a0a0a] shadow-[4px_4px_0_#0a0a0a]">Правка</span>
                      ...
                      <div className="absolute bottom-7 left-1/2 -translate-x-1/2 w-24 sm:w-28 h-14">
                        <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[72%] h-10 bg-[#171717] border-[3px] border-[#0a0a0a]">
                          <div className="absolute inset-[4px] bg-[#2a3fc7] flex items-center justify-center">
                            <span className="w-2 h-2 bg-[#00b8d9] shadow-[8px_0_0_#e6007e,16px_0_0_#f2d500]" />
                          </div>
                        </div>
                  ...
                  <div className="absolute top-4 left-4 px-3 py-1.5 text-[10px] sm:text-xs uppercase tracking-[0.16em] bg-[#090909] text-white border-2 border-white/70 shadow-[3px_3px_0_#2a3fc7]">
                    {game.tag}
                  </div>
                </div>
